...
namespace SeleniumApplication.PageObject.Input
{
    public static class PageObjectSelectDropdownList
    {
        ...
        public static readonly IList<string> ListOfMultiSelectValue = new ReadOnlyCollection<string>
        (new List<string> {
        ...
        public static SelectElement GetSelectListDropdown(ChromeDriver driver)
        {
        ...
        public static IWebElement GetDisplaySelectListValue(ChromeDriver driver) => Helpers.GetWebElement(driver, XPathDisplaySelectListValue);

        public static SelectElement GetSelectMultiListDropdown(ChromeDriver driver)
        {
        ...
        public static IWebElement GetButtonFirstSelect(ChromeDriver driver) => Helpers.GetWebElement(driver, XPathButtonFirstSelect);

        public static IWebElement GetButtonGetAllSelected(ChromeDriver driver) => Helpers.GetWebElement(driver, XPathButtonGetAllSelected);

        public static IWebElement GetDisplayMultiSelectDropdown(ChromeDriver driver) => Helpers.GetWebElement(driver, XPathDisplayMultiSelectDropdown);
